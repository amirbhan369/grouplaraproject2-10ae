[grouplaraproject2-10ae] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [grouplaraproject2-10ae] container is NOT running**.

.. tip::
   You must have your [grouplaraproject2-10ae] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   dockeramir33/grouplaraproject2-10ae-amd64 (https://hub.docker.com/r/dockeramir33/grouplaraproject2-10ae-amd64)
...
.. code-block::
   ...
   docker run -d -p 54895:54895 -p 39205:39205 -p 33961:33961 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=grouplaraproject2-10ae \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-grouplaraproject2-10ae \
          --env GITUSERNAME=amirbhan369 \
          --env GITREPOURL=https://github.com/amirbhan369/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=54895 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=39205  \
          --env SOLUTIONVIPERVIZPORT=33961 \
          ...
          dockeramir33/grouplaraproject2-10ae-amd64
...
[grouplaraproject2-10ae] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/amirbhan369/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/grouplaraproject2-10ae
...
.. important::
   https://grouplaraproject2-10ae.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-grouplaraproject2-10ae
...
.. important::
   VIPERHOST_PRODUCE=192.168.49.1, VIPERPORT_PRODUCE=54895, VIPERHOST_PREPOCESS=192.168.49.1, VIPERPORT_PREPROCESS=45021, VIPERHOST_PREPOCESS2=192.168.49.1, VIPERPORT_PREPROCESS2=43999, VIPERHOST_PREPOCESS_PGPT=192.168.49.1, VIPERPORT_PREPROCESS_PGPT=39583, VIPERHOST_ML=192.168.49.1, VIPERPORT_ML=34761, VIPERHOST_PREDCT=192.168.49.1, VIPERPORT_PREDICT=37515, HPDEHOST=192.168.49.1, HPDEPORT=45853, HPDEHOST_PREDICT=192.168.49.1, HPDEPORT_PREDICT=38287

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6092-grouplaraproject2-10ae,solution_preprocessing_ai_mqtt_dag-grouplaraproject2-10ae, python-preprocess-7965-grouplaraproject2-10ae,solution_preprocessing_ai_mqtt_dag-grouplaraproject2-10ae, python-ai-6201-grouplaraproject2-10ae,solution_preprocessing_ai_mqtt_dag-grouplaraproject2-10ae, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
